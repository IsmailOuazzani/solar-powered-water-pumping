...
from loss_analysis import lpsp, lpsp_total
...
hourly_water_need = 2000 * 0.02 / 24  # m^3/hour
...
if __name__ == "__main__":
    ...
    lon_lat_pairs = mask_lon_lat(lon,lat, country_name="Burundi")
    ...
    plot_heatmap(lon_lat_pairs=lon_lat_pairs, 
                 ...
                 legend="Total power generated by the pv system (W)",
                 hue_style="orange")    
    plot_heatmap(
