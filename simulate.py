...
COUNTRY="Morocco"
OUTPUT_DIR = Path("outputs") / time.strftime("%Y-%m-%d_%H-%M-%S")
...
if __name__ == "__main__":
    ...
    if args.type == "global":
        ...
        plot_heatmap(lon_lat_pairs=lon_lat_pairs, 
                    ...
                    output_file=OUTPUT_DIR/"total_power.png", 
        ...
        plot_heatmap(
            ...
            output_file=OUTPUT_DIR/"water_in_tank_end_january_1st.png",
            legend="Fill Level Percentage"
        )
        plot_heatmap(
            lon_lat_pairs=lon_lat_pairs,
            values=np.array(losses_total),
            output_file=OUTPUT_DIR/"lossfct.png",
